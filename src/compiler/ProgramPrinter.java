...
public class ProgramPrinter implements MoolaListener {
    ...
    public void enterClassDeclaration(MoolaParser.ClassDeclarationContext ctx) {
        String space = "    ";
        if (ctx.getParent() instanceof MoolaParser.EntryClassDeclarationContext)
            space = "";
        String text = space + "class: " + ctx.className.getText();
        if (ctx.classParent != null)
            text += "/ class parent: (" + ctx.classParent.getText() + ")";
        text += "{";
    ...
    public void enterFieldDeclaration(MoolaParser.FieldDeclarationContext ctx) {
        ...
        for (TerminalNode id: ids) {
            System.out.println("        filed: " + id + "/ type=" + ctx.fieldType.getText()
    ...
    public void enterMethodDeclaration(MoolaParser.MethodDeclarationContext ctx) {
        ...
        System.out.println("        class method: " + ctx.methodName.getText() + "/ return type=" + ctx.t.getText()
                + "/ access modifier=" + accessModifier + "{");
    }
